...
- [0007 — Result-size handling: hard cap, truncation signal, aggregation push-down](decisions/0007-result-size-handling.md)
- [0008 — Dataset generation: seeded, calibrated to sourced distributions](decisions/0008-dataset-generation.md)
- [0009 — Auth implementation: PBKDF2 password hashing, pinned-algorithm JWT](decisions/0009-auth-implementation.md)
